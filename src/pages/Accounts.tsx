              ...
              return (
                ...
                >
                  ...
                  <div className="account-status-result">
                    ...
                    <span style={{ backgroundColor: 'var(--surface-subtle)', color: 'var(--text-primary)', padding: '0.1rem 0.4rem', border: '2px solid var(--border-color)', borderRadius: '4px', fontSize: '0.75rem', fontWeight: 900, boxShadow: 'var(--shadow-sm)' }}>
                      {status.statusLabel}
                    </span>
      ...
      {selectedStatus && (
        ...
        >
          ...
          <div className="account-detail-body">
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1.5rem', marginBottom: '2.5rem', padding: '1.25rem', backgroundColor: 'var(--surface-color)', borderRadius: 'var(--radius-lg)', border: '2px solid var(--border-color)', boxShadow: 'var(--shadow-md)' }}>
            ...
            {selectedStatus.configured && (
              <section className="account-detail-section" aria-labelledby="current-account-payments-title" style={{ marginBottom: '2.5rem' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', paddingBottom: '0.75rem', borderBottom: '2px solid var(--border-color)', marginBottom: '1.25rem' }}>
                  ...
                  <span style={{ background: 'var(--surface-color)', border: '2px solid var(--border-color)', padding: '0.1rem 0.6rem', borderRadius: '999px', fontSize: '0.85rem', fontWeight: 900, boxShadow: 'var(--shadow-sm)' }}>{selectedStatus.currentPayments.length}</span>
                </div>
