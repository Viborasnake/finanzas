    ...
    <div className="auth-shell" style={{ display: 'flex', minHeight: '100vh', backgroundColor: 'var(--bg-color)' }}>
      ...
      >
        <div className="auth-form-inner" style={{ width: '100%', maxWidth: '400px' }}>
          ...
          {/* Tabs */}
          {!isPasswordRecovery && (
            <div className="auth-tabs" role="tablist" aria-label="Acceso a MisFinanzas" style={{ display: 'flex', backgroundColor: 'var(--surface-color)', borderRadius: '999px', border: '2px solid var(--border-color)', marginBottom: '2.5rem', padding: '0.25rem', boxShadow: 'var(--shadow-md)' }}>
              <button
                type="button"
                role="tab"
                id="auth-tab-login"
          ...
          >
            ...
            {error && (
              <div role="alert" style={{ backgroundColor: 'var(--danger-surface)', color: 'var(--danger-text)', padding: '0.75rem', borderRadius: 'var(--radius-md)', marginBottom: '1.5rem', border: '2px solid var(--border-color)', boxShadow: 'var(--shadow-sm)', fontWeight: 700, fontSize: '0.875rem' }}>
                {error}
              </div>
            )}
