  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem' }}>
      <div className="card" style={{ backgroundColor: 'var(--pastel-yellow)', marginBottom: '2rem' }}>
        ...
        <button type="button" className="btn" style={{ backgroundColor: 'var(--primary)', color: 'var(--surface-color)', marginTop: '1rem', width: '100%', justifyContent: 'center' }} onClick={handleDownload}>
          <Download size={20} />
