...
10. **Saldo inicial por periodo:** Derivarlo automáticamente del último saldo bancario reportado antes del inicio del periodo. El flujo neto siempre usa exclusivamente las fechas seleccionadas; el saldo anterior se presenta aparte como contexto y nunca se suma ni resta al flujo. No inventar montos para bancos o formatos que no informan saldo ni dirigir al ajuste inicial anual; indicar qué bancos quedan fuera de la estimación porque su cartola no entrega ese dato.
