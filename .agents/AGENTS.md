...
13. **Pago de tarjeta:** Un movimiento clasificado como `Pago Tarjeta Crédito` liquida deuda generada por consumos anteriores. Mantenerlo visible como pago de deuda, pero excluirlo de los gastos originados en el periodo para no duplicar los consumos importados de la tarjeta.
...
15. **Cobertura de tarjeta:** La exclusión de un pago de tarjeta del consumo debe acompañarse de conciliación contra compras con `source_kind = 'card_activity_screenshot'`. Cobertura ausente o parcial genera una advertencia visible; nunca presentar el consumo como exacto en silencio.
